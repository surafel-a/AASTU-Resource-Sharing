      ...
      <div className="mx-4 sm:mx-6 lg:mx-12 xl:mx-20 2xl:mx-32">
        ...
        <div className="flex flex-col xl:flex-row gap-8">
          ...
          <section className="flex flex-col gap-6 w-full xl:w-[30%]">
            ...
            <div className="p-6 sm:p-8 bg-white shadow-lg rounded-2xl">
              <div className="flex items-center gap-3 mb-6 text-xl font-bold">
                <FontAwesomeIcon icon={faLock} className="text-[#1152D4]" />
                <p>Change Password</p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={field.key} className="flex flex-col gap-1">
                    <label className="font-semibold text-sm text-black/50">
                      {field.label}
                    </label>
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-10 rounded-xl bg-[#F6F6F8] focus:outline-none focus:ring-2 focus:ring-[#1152D4] ring-1 ring-black/10"
                        placeholder="••••••••"
                      />
                      <button
                        type="button"
                      ...
                      >
                        <FontAwesomeIcon
                          icon={field.show ? faEye : faEyeSlash}
                        />
                      </button>
                    </div>
                  </div>
                ...
                {pwForm.newPasswordConfirm && (
                  <p
                    className={`text-xs font-semibold ${
                      pwForm.newPassword === pwForm.newPasswordConfirm
                        ? "text-green-600"
                        : "text-red-500"
                    }`}
                  >
                ...
                <button
                  ...
                  disabled={pwLoading}
                  className={`mt-2 w-full py-3 rounded-xl font-semibold text-white transition cursor-pointer ${
                    pwLoading
                      ? "bg-blue-400 opacity-70 cursor-not-allowed"
                      : "bg-[#1152D4] hover:bg-blue-700"
                  }`}
                >
